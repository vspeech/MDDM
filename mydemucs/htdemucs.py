...
from mydemucs.transformer import CrossTransformerEncoder

from mydemucs.demucs import rescale_module
from mydemucs.states import capture_init
from mydemucs.spec import spectro, ispectro
from mydemucs.hdemucs import pad1d, ScaledEmbedding, HEncLayer, MultiWrap, HDecLayer
...
class HTDemucs(nn.Module):
    ...
    def __init__(
        ...
        for index in range(depth):
            ...
            if depth >= 5 and index >= depth - 1:
                chout_z = channels * growth ** (depth - 2)
                chout = chout_z
        ...
        #att_hidden_dim = channels * 3
        att_hidden_dim = transformer_channels
        if bottom_channels:
